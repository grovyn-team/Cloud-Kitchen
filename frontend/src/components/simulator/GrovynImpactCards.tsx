    ...
    <div className="space-y-6">
      ...
      <Card className="overflow-hidden rounded-xl border-2 border-[#22c55e]/30 bg-[#22c55e]/10">
        <CardContent className="flex items-center justify-between p-4">
          <div><div className="text-sm text-muted-foreground">Total {siteConfig.shortName} value</div><div className="mt-1 text-xs text-muted-foreground">Combined impact</div></div>
